...
&nbsp;
	<div style="display: flex;align-items: center;">
		&nbsp;&nbsp;&nbsp;<img width="100" height="35" src="images/my_logo.png">
  ...
  ?>
	...
	<!--trait de separation-->
	 ...
	 <div class="swiper mySwiper">
      ...
      <?php
      $req ="SELECT*FROM publication ORDER BY idPub DESC";
      ...
      if(mysqli_num_rows($result) > 0){
        while($row = mysqli_fetch_assoc($result)){?>
          ...
          <div class="swiper-slide">
            <img class="img_scroll" src="immage/<?=$row['pubimg']?>" alt="image">
    ...
    <form action="recuppub.php" method="post" enctype="multipart/form-data">
        ...
        <label  for="">Corps de message</label>
